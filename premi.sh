...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/DEFF-OFFICIAL/install/main/"
...
wget -q https://raw.githubusercontent.com/DEFF-OFFICIAL/install/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
